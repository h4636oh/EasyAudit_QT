...
# Set the minimum user ID to filter for successful and unsuccessful attempts to use the usermod command
...
' >> /etc/audit/rules.d/50-usermod.rules"
    echo "Audit rules have been added to /etc/audit/rules.d/50-usermod.rules"
else
