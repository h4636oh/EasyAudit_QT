...
# This script audits whether the GDM disable-user-list option is enabled on GNOME systems.
# It checks the configuration on both Debian-based and RPM-based systems.
